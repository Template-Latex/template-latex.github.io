        ...
        var Parallax = function () {
            ...
            _createClass(Parallax, [{
                ...
                value: function render() {
                    ...
                    this.$m.css({
                        transform: 'translate3d(' + options.mirrorLeft + 'px, ' + (options.mirrorTop - overScroll) + 'px, 0px) scale(1.05)',
                    ...
                    this.$s.css({
                        transform: 'translate3d(' + options.offsetLeft + 'px, ' + options.offsetTop + 'px, 0px) scale(1.05)',
                        position: 'absolute',
