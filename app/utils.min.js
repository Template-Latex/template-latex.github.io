...
function addDownloadCounter(a){let b=210;100>a?b=140:1E3<=a<1E4&&(b=230);if(1E3<=a){let c=1;1E4>=a&&(c=10);a=(Math.round(a*c/1E3)/c).toString()+"k"}else a=a.toString();$("#templatestats").html(`
    <svg xmlns="http://www.w3.org/2000/svg" width="98" height="20" role="img" aria-label="Descargas: ${a}">
       <title>Descargas: ${a}</title>
       ...
       <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
          <text aria-hidden="true" x="345" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="${370+b}">Descargas</text>
          <text x="345" y="140" transform="scale(.1)" fill="#fff" textLength="570">Descargas</text>
          <text aria-hidden="true" x="815" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="${b}">${a}</text>
          <text x="815" y="140" transform="scale(.1)" fill="#fff" textLength="${b}">${a}</text>
       </g>
    </svg>`)};
