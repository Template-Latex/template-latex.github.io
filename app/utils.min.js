...
function addDownloadCounter(a){let b=210;100>a&&(b=150);if(1E3<=a){let c=1;1E4>=a&&(c=10);a=(Math.round(a*c/1E3)/c).toString()+"k"}else a=a.toString();$("#templatestats").html(`
